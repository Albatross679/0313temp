...
### Algorithm Priority
- GRPO first as primary algorithm, CISPO as a config-selectable variant
...
- Wall-clock time budget per config within the 1-2hr total
...
- The experiment should be structured as: baseline (SFT/DPO) vs GRPO vs CISPO comparison
