...
\begin{tabular}{lccc}
  ...
  \midrule
  SFT baseline (T5-base) & 73.39 & 84.76 & 85.96 \\
  DPO epoch 0 (= SFT) & 73.39 & 84.76 & 85.96 \\
  DPO best (epoch 2, $\beta$=0.1, LR=5e-6) & 71.24 & 83.69 & 84.82 \\
  DPO final eval (best ckpt, beam=4) & 68.67 & 81.12 & 82.42 \\
  \midrule
...
\begin{enumerate}
  ...
  \item \textbf{Reward hacking / overfitting.} The reward margin grew from 0.01 to 12.2 over 7 epochs while dev F1 peaked at epoch 2 and collapsed to 71.7\% by epoch 7. The policy learned to maximize the DPO reward signal without improving SQL correctness, a form of reward hacking on the fixed preference dataset.
\end{enumerate}
