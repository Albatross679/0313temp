...
\midrule
OS & Ubuntu 22.04 LTS (Linux 5.4, x86\_64) \\
GPU & NVIDIA A40 (46\,GB VRAM), 1 of 1 available \\
GPU driver & NVIDIA 535.129.03 \\
CPU & AMD EPYC 7H12 64-Core (128 threads) \\
RAM & 1\,TB system memory \\
Storage & 50\,GB overlay (NVMe-backed) \\
Software & Python 3.10, PyTorch 2.10, Transformers 5.2 \\
CUDA / cuDNN & 12.2 / 9.1 \\
Batch sizing & Automatic per-config tuning to maximize VRAM utilization \\
\bottomrule
\end{tabular}
\caption{Hardware and software environment used for all experiments (Parts 1--3).}
\label{tab:hardware}
\end{table}
