#!/usr/bin/env python3
"""Load a T5 fine-tune checkpoint from an output dir and evaluate on dev examples.
...
def main():
    ...
    min_new_tokens = cfg.get("min_new_tokens", None)
    length_penalty = cfg.get("length_penalty", None)
    all_preds = []
